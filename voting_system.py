...
class VotingSystem:
    ...
    def update_track(self, track_id, label, score):
        """
        Update the history for a given track with new label and score.
        """
    ...
    def get_voted_label_and_score(self, track_id):
        """
        Get the most frequent label and average score for a given track.
        Use initial label and score if not enough data.
        """
        history = self.track_history[track_id]
