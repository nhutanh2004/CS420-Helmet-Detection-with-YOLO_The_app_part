...
if os.path.exists(
    "deep_sort_realtime\deep_sort_realtime\embedder\weights\mobilenetv2_bottleneck_wts.pt"
):
    print("mobilenetv2_bottleneck_wts.pt exists\n")
else:
    print("mobilenetv2_bottleneck_wts.pt does not exist\n")

if os.path.exists(
    "deep_sort_realtime\deep_sort_realtime\embedder\weights\osnet_ain_ms_d_c_wtsonly.pth"
):
    print("osnet_ain_ms_d_c_wtsonly.pth exists\n")
else:
    print("osnet_ain_ms_d_c_wtsonly.pth does not exist\n")

MOBILENETV2_BOTTLENECK_WTS = "deep_sort_realtime\deep_sort_realtime\embedder\weights\mobilenetv2_bottleneck_wts.pt"

TORCHREID_OSNET_AIN_X1_0_MS_D_C_WTS = "deep_sort_realtime\deep_sort_realtime\embedder\weights\osnet_ain_ms_d_c_wtsonly.pth"
...
#     "deep_sort_realtime",
#     "embedder/weights/osnet_ain_ms_d_c_wtsonly.pth",
# )
...
class TorchReID_Embedder(object):
    ...
    def __init__(
        ...
        try:
            ...
            raise Exception(
                "ImportError: torchreid is not installed, please install and try again or choose another embedder"
            )
